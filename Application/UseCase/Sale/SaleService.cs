...
public class SaleServices : ISaleServices
{
    ...
    public SaleServices(ISaleCommands command, ISaleQuery query, IProductServices productServices, ISaleProductServices saleProductServices)
    {
        _command = command;
        _query = query;
    ...
    private async Task<List<SaleGetResponse>> CreateSaleGetResponses(List<Sale> sales)
    {
        ...
        {
            List<SaleProductResponse> saleProductResponses = await _saleProductServices.GetSaleProductBySaleId(sale.SaleId);
            int totalQuantity = 0;
    ...
    {
        Sale sale = await _query.GetSaleById(saleId);
        return sale;
    }
    ...
    public async Task<List<SaleProductResponse>> InsertSaleProducts(Sale sale, Dictionary<ProductResponse, int> productsAndQuantities)
    {
    ...
    public async Task<SaleResponse> GetSaleDetails(int id)
    {
